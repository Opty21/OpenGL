...
void main()
{
	...
	vec3  lightPart = Calculate_PointLight(myLight, CameraPosition, inPosition.xyz, inNormal);

	// Cienie
	float shadowPart = Calculate_ShadowPoint(myLight.Position, inPosition.xyz, FarPlane);
