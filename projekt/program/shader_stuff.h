...
{
        _scene_rotate_y += mouseSensitivity*(x - GLUT_WINDOW_WIDTH/2)/(float)glutGet( GLUT_WINDOW_WIDTH );
        _mouse_buttonX = x;
        _scene_rotate_x -= mouseSensitivity*(GLUT_WINDOW_HEIGHT/2 - y)/(float)glutGet( GLUT_WINDOW_HEIGHT );
        _mouse_buttonY = y;
