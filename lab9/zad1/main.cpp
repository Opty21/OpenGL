...
CMesh road, mon,candle,candle2,coolGuy,christmasTree,coolGuy3,plane,santa;
...
CTexture metalPlates,christmasTreeTex,santaFace;
...
int w=600,h=800;
void displayFPS(),drawToScene(),drawToTexture();
// ---------------------------------------
void DisplayScene()
{
