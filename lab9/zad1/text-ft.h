...
void InitText(const char *font_filename, int font_size)
{
    ...
    glAttachShader( text_program, LoadShader(GL_VERTEX_SHADER, "Shaders/Vertex/text-ft-vertex.glsl"));
    glAttachShader( text_program, LoadShader(GL_FRAGMENT_SHADER, "Shaders/Fragment/text-ft-fragment.glsl"));
